...
* [The model object can be found here](Activate.PHP/Activate.PHP/Model/MerchantData.php).
* [The code that converts the model to JSON can be found here](Activate.PHP/Activate.PHP/Helpers/ObjectHelper.php).
